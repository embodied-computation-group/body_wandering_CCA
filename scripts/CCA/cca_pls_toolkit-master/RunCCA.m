...
% X = fMRI connectivity data %
% Y = behavioural data (body/mind-wandering items)

%% set cfg
% Project folder
cfg.dir.project = '/home/leah/Git/connectivity_tools/toolboxes/matlab/cca_pls_toolkit-master/_Project_BodyWandering/'; 
